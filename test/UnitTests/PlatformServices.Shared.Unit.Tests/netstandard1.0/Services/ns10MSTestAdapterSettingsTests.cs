...
#pragma warning restore SA1649 // File name must match first type name
    {
        ...
        public void GetDirectoryListWithRecursivePropertyShouldReadRunSettingCorrectly()
        {
            ...
            expectedResult.Add(new RecursiveDirectoryPath(@"C:\MsTest\Adapter", true, true));
            expectedResult.Add(new RecursiveDirectoryPath(@"C:\foo\unitTesting\MsTest\Adapter", false, true));
